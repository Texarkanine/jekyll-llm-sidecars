...
`README.md` is the output contract. One generator pass selects documents, registers one `JekyllLlmSidecars::Entry` per document, and fills that entry's summary slot and body slot at most once. Scopes and the manifest hold those entry objects.
